...
import { projectDetailScrollClasses } from "./projectDetailScrollClasses";
...
export function ProjectDetailScreen(props: ProjectDetailScreenProps) {
  ...
  const scrollMode = issueOwnsScroll ? "owned" : "default";
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-row overflow-hidden">
        ...
        >
          <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden [container-type:inline-size]">
            ...
            <div
              className={projectDetailScrollClasses.scroll[scrollMode]}
              data-testid="project-detail-scroll"
            >
              <div
                className={projectDetailScrollClasses.content[scrollMode]}
              >
                <WorkspaceTabs
